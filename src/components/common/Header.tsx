                    ...
                    <AnimatePresence>
                      {suggestionsOpen && suggestions.length > 0 && (
                        ...
                        >
                          {suggestions.map((s, i) => (
                            <li key={i}>
                              <button className="suggestion-item" onClick={() => handleSearch(s)}>
                      ...
                      <div className="recent-searches">
                        ...
                        <ul>
                          {recentSearches.map((s, i) => (
                            <li key={i}>
                              <button className="suggestion-item recent-item" onClick={() => handleSearch(s)}>
                                <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <polyline points="1 4 1 10 7 10" strokeWidth="2" strokeLinecap="round" />
                                  <path d="M3.51 15a9 9 0 1 0 .49-4" strokeWidth="2" strokeLinecap="round" />
                                </svg>
                                {s}
                              </button>
                            </li>
            ...
            {isAuthenticated ? (
              <div className="user-menu-wrap" ref={userMenuRef}>
                ...
                >
                  ...
                  <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" className={`chevron ${userMenuOpen ? 'chevron-up' : ''}`}>
                    ...
                    >
                      ...
                      <Link to="/orders" className="user-dropdown-item">
                        <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2" strokeWidth="2" strokeLinecap="round" />
            ...
            >
              ...
              {isAuthenticated ? (
                <div className="mobile-auth">
                  ...
                  <button className="mobile-logout-btn" onClick={() => { handleLogout(); setMenuOpen(false); }}>
                    Logout
                  </button>
                </div>
              ) : (
