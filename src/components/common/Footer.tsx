      ...
      <div className="footer-main container">
        ...
        <div className="footer-brand">
          <div className="footer-logo">
            ...
            <span className="footer-logo-text">FashionZone</span>
          </div>
          <p className="footer-tagline">
            Elevate your style. Discover the latest trends and timeless classics—all in one place.
          </p>
        ...
        <div className="footer-newsletter">
          ...
          <p className="newsletter-desc">
            Subscribe to get exclusive deals, style inspiration and early access to new arrivals.
          </p>
